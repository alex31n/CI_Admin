...
class MY_Controller extends MX_Controller
{
	...
	{
		$this->config->load('ax_config_admin');
		$config= $this->config->load('ax_config');
		$config_admin = $this->config->item('ax_config_admin');
		$config = array_merge($config, $config_admin);
		...
		if (!empty($lang_config)) {
			...
			// get language from URL, or from config's default value (in ax_config.php)
